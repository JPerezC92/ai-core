...
|---|---|---|---|---|
| `incident-query-verification-pilot` | Incident query-verification pilot | active | incident-diagnostics | `.opencode/skills/query-verification/`, `.opencode/skills/ticket-runbook/`, `.opencode/agents/crucible.md`, `knowledge/` |
| `register-first-incident-identification` | Register-first incident identification | active | incident-diagnostics | `.opencode/skills/ticket-runbook/`, `knowledge/symptoms.md`, `knowledge/problems.md`, `knowledge/agents.md`, `.opencode/agents/investigator.md`, `.opencode/agents/ledger.md`, `.opencode/agents/quill.md` |
...
| `plan-enforce-plan-audit-gate` | Plan-enforce plan audit gate | active | plan-governance | `.opencode/skills/plan-enforce/`, `user-stories/` |
