...
7. **PR-head handoff and retained checkout** (after `gh pr create`):
    ...
    - Keep the PR-head checkout and its review context intact. Do not run `git checkout main` or perform other cleanup until Cipher 🔓 (L2 Lead) relays Inquisitor's [PASS] or explicitly acknowledged [ADVISORY] result.
